  ...
  <xsl:function name="yxj:timeline">
    ...
    <g class="timelineHeader">
      ...
      <xsl:for-each select="1 to 4">
        ...
        <g id="y{$yearArray[5-$index]}">
          <path d="M{670 - ($index -1)*$xInterval} 30H{885.238 - ($index -1)*$xInterval}L{896 - ($index -1)*$xInterval} 40.5L{885.238 - ($index -1)*$xInterval} 51H{670 - ($index -1)*$xInterval}V30Z" fill="{$colorArray[5-$index]}"/>
          <text x='{775.5 - ($index -1)*$xInterval}' y='20'
            fill="{$colorArray[5-$index]}" text-anchor="middle" font-size="2em">
            <xsl:value-of select="$yearArray[5-$index]"/>
          </text>
          <path d="M{775.5 - ($index -1)*$xInterval} 45L{768.139 - ($index -1)*$xInterval} 36H{782.861 - ($index -1)*$xInterval}L{775.5 - ($index -1)*$xInterval} 45Z" fill="#D9D9D9"/>
        </g>
      </xsl:for-each>
    ...
    <g class="calendar" transform="translate(50, {$yInterval*3.5})" fill="{$colorArray[1]}">
    ...
    <g transform="translate(50, {$yInterval*3.5})">
      <xsl:for-each select="$Coll">
        ...
        <g class="{$currentLetter}" fill="{$colorArray[$index]}"
          ...
          <circle cx="{$lineX}" cy="{$moveUpUnit[$index]*$yInterval}" r="5"
